"""
Django settings for beragam_roastlog project.
...
ALLOWED_HOSTS = ['beragam-db.herokuapp.com']
# 127.0.0.1
...
ROOT_URLCONF = 'beragam_roastlog.urls'
...
WSGI_APPLICATION = 'beragam_roastlog.wsgi.application'
